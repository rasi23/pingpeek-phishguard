...
export default {
	...
	theme: {
      ...
      boxShadow: {
        'frost': '0 8px 32px rgba(31, 38, 135, 0.15)',
        'neon': '0 0 5px theme("colors.primary.DEFAULT"), 0 0 20px rgba(var(--primary), 0.2)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-subtle': 'linear-gradient(to right, rgb(240, 243, 252), rgb(255, 255, 255))',
